...
class LulusLivewire extends Component
{
    use WithPagination;
    ...
    {
        return view('livewire.lulus-livewire', [
            'siswa' => Siswa::where('nama_siswa', 'like', '%' . $this->search . '%')->where('lulus', 'Sudah Lulus')->orderBy('nama_siswa')->paginate($this->paginate)
        ]);
    }
