...
class MagangExport implements WithHeadings, WithEvents, ShouldAutoSize
{
    use Exportable;
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) use ($styleHeader, $styleInput) {
                ...
                $event->sheet->getStyle("A1:G$row")->getBorders()->getAllBorders()->setBorderStyle('thin');
                ...
                $event->sheet->getStyle("G2:G$row")->applyFromArray($styleInput);
            },
        ];
    }
}
